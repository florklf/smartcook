...
return [
    ...
    */
    ...
    | spécifier rapidement une ligne de langage personnalisée spécifique pour une règle d'attribut donnée.
    |
    */
    ...
    | avec quelque chose de plus convivial pour le lecteur, comme "Adresse e-mail" au lieu de "email".
